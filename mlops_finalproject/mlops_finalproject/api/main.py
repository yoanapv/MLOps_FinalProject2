...
def predict(hotelreservation_features: HotelReservation):
    predictor = ModelPredictor("/Users/norma.perez/Documents/GitHub/MLOps_FinalProject/mlops_finalproject/mlops_finalproject/models/extra_trees_classifier_model_output.pkl")
